...
class CursorRulesTools:
    ...
    def register_tools(self, mcp):
        ...
        @mcp.tool()
        def update_auto_rule(content: str, backup: bool = True) -> Dict[str, Any]:
        ...
        @mcp.tool()
        def validate_rules(file_path: Optional[str] = None) -> Dict[str, Any]:
        ...
        def manage_cursor_rules(
            action: str, target: Optional[str] = None, content: Optional[str] = None
        ) -> Dict[str, Any]:
        ...
        def regenerate_auto_rule(
            role: Optional[str] = None, task_context: Optional[Dict[str, Any]] = None
        ) -> Dict[str, Any]:
        ...
        def validate_tasks_json(
            file_path: Optional[str] = None, output_format: str = "summary"
        ) -> Dict[str, Any]:
