...
class ProjectAnalyzer:
    ...
    def generate_context_summary(self, task_phase: str = "coding") -> str:
        ...
        return self.context_generator.generate_context_summary(
            structure, patterns, dependencies, task_phase
        )

    def save_context_to_file(
        self, context_file: Path, task_phase: str = "coding"
    ) -> bool:
        ...
        phase_specific_context = self.context_generator._get_phase_specific_context(
            task_phase, patterns
        )
        ...
        return self.file_operations.save_context_to_file(
            context_file, context_data, task_phase
        )
    ...
    def _get_phase_specific_context(self, phase: str) -> str:
        ...
        return self.context_generator._get_phase_specific_context(
            phase, self.detect_existing_patterns()
        )
