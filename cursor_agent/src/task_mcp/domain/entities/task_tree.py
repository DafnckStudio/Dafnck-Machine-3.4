...
class TaskTree:
        ...
        for subtask_data in task.subtasks:
            ...
            if subtask_id and subtask_id not in self.all_tasks:
                ...
                subtask = Task.create(
                    ...
                    assignees=(
                        subtask_data.get("assignees", [])
                        or [subtask_data.get("assignee", "")]
                        if subtask_data.get("assignee")
                        else []
                    ),
                )
    ...
    def get_dependency_graph(self) -> Dict:
        ...
        for task in self.all_tasks.values():
            ...
            dependencies = [
                dep.value for dep in task.dependencies if dep.value in self.all_tasks
            ]
