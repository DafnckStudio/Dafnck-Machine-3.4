...
from src.task_mcp.interface.consolidated_mcp_server import (
...
class TestConsolidatedMCPServer:
    ...
    def test_main_keyboard_interrupt(self, mock_logging, mock_create_server):
        ...
        # Verify server was created and attempted to run
        mock_create_server.assert_called_once()
        mock_mcp.run.assert_called_once()
    ...
    def test_main_server_creation_failure(self, mock_logging, mock_create_server):
        ...
        # Verify server creation was attempted
        mock_create_server.assert_called_once()
    ...
    def test_module_imports_successfully(self):
        ...
        import src.task_mcp.interface.consolidated_mcp_server
    ...
    def test_module_docstring(self):
        ...
        import src.task_mcp.interface.consolidated_mcp_server as module
