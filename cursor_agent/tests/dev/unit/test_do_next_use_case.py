...
from task_mcp.application.use_cases.do_next import DoNextUseCase, DoNextResponse
...
class TestDoNextUseCase:
    ...
    def setup_method(self):
        ...
        self.patcher = patch('task_mcp.domain.value_objects.task_id.datetime')
    ...
    def test_execute_task_with_incomplete_subtasks(self):
        ...
        self.mock_repository.find_all.return_value = [task]
        with patch("task_mcp.application.use_cases.do_next.generate_docs_for_assignees") as mock_gen:
            result = self.use_case.execute()
