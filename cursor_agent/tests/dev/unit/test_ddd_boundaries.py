...
class TestDDDLayerBoundaries:
    ...
    def test_domain_layer_independence(self):
        ...
        import task_mcp.domain.entities.task as task_module
        import task_mcp.domain.value_objects.task_id as task_id_module
        import task_mcp.domain.value_objects.task_status as task_status_module
        import task_mcp.domain.value_objects.priority as priority_module
        import task_mcp.domain.events.task_events as events_module
        ...
        for module in [task_module, task_id_module, task_status_module, priority_module, events_module]:
            ...
            for forbidden in forbidden_imports:
                ...
                assert f'from task_mcp.{forbidden}' not in source, f"Domain layer should not import from {forbidden} layer"
    
    @pytest.mark.unit
    @pytest.mark.architecture
    def test_application_layer_dependencies(self):
        """Test that application layer only depends on domain layer."""
        import task_mcp.application.services.task_application_service as app_service_module
        
        source = inspect.getsource(app_service_module)
        
        # Application layer can import from domain
        assert 'from task_mcp.domain' in source or 'from ..domain' in source or 'from ...domain' in source
        
        # Application layer should not import from infrastructure or interface
        assert 'from task_mcp.infrastructure' not in source
        assert 'from task_mcp.interface' not in source
    ...
    def test_infrastructure_layer_dependencies(self):
        ...
        import task_mcp.infrastructure.repositories.json_task_repository as repo_module
        import task_mcp.infrastructure.services.file_auto_rule_generator as generator_module
    ...
    def test_interface_layer_dependencies(self):
        ...
        import task_mcp.interface.consolidated_mcp_tools_v2 as mcp_tools_module
        
        source = inspect.getsource(mcp_tools_module)
        
        # Interface layer should import from application (and possibly others)
        assert ('from task_mcp.application' in source or 
    ...
    def test_domain_events_pattern(self):
        ...
        from task_mcp.domain.entities.task import Task
        from task_mcp.domain.value_objects.task_id import TaskId
        from task_mcp.domain.events.task_events import TaskUpdated, TaskCreated, TaskRetrieved
    ...
    def test_repository_pattern_interface(self):
        ...
        from task_mcp.domain.repositories.task_repository import TaskRepository
    ...
    def test_use_case_separation(self):
        ...
        import task_mcp.application.use_cases.create_task as create_task_module
        import task_mcp.application.use_cases.get_task as get_task_module
        import task_mcp.application.use_cases.update_task as update_task_module
        import task_mcp.application.use_cases.delete_task as delete_task_module
    ...
    def test_dto_pattern_usage(self):
        ...
        from task_mcp.application.dtos.task_dto import TaskResponse
    ...
    def test_clean_architecture_compliance(self):
        ...
        import task_mcp.domain.entities.task
        import task_mcp.domain.value_objects.task_id
        
        # Application layer - depends only on domain
        import task_mcp.application.services.task_application_service
        
        # Infrastructure layer - depends on domain and application
        import task_mcp.infrastructure.repositories.json_task_repository
        
        # Interface layer (outermost) - depends on all inner layers
        import task_mcp.interface.mcp_tools
