...
from src.task_mcp.infrastructure.services.agent_doc_generator import generate_agent_docs, generate_docs_for_assignees
from src.task_mcp.application.use_cases.get_task import GetTaskUseCase
from src.task_mcp.domain.events import TaskRetrieved
from src.task_mcp.domain.value_objects import TaskId
...
def temp_agent_setup():
    ...
    (coding_agent_dir / "contexts").mkdir()
    ...
    # Patch the constants
    with patch('src.task_mcp.infrastructure.services.agent_doc_generator.AGENT_YAML_LIB', agent_yaml_lib_path), \
         patch('src.task_mcp.infrastructure.services.agent_doc_generator.AGENTS_OUTPUT_DIR', agents_output_dir_path):
...
class TestAgentDocGeneration:
    ...
    def test_get_task_use_case_triggers_doc_generation(self, temp_agent_setup):
        ...
        with patch('src.task_mcp.application.use_cases.get_task.generate_docs_for_assignees') as mock_generate:
