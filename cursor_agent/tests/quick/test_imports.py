...
def test_can_import_mcp_server():
    ...
    try:
        from task_mcp.interface.ddd_mcp_server import create_mcp_server, main
...
def test_can_import_events():
    ...
    try:
        from task_mcp.domain.events.task_events import TaskCreated, TaskUpdated, TaskRetrieved, TaskDeleted
...
def test_can_import_exceptions():
    ...
    try:
        from task_mcp.domain.exceptions.task_exceptions import TaskNotFoundError, InvalidTaskStateError, InvalidTaskTransitionError
